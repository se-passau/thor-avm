...
{
    public static class IntergenCrossoverFactory
    {
        /// <summary>
        ...
        public static Crossover GetCrossoverOperator(string name, Dictionary<string, object> parameters)
        {
            ...
            else if (name.Equals("IntergenCrossover", StringComparison.InvariantCultureIgnoreCase))
                return new IntergenCrossover(parameters);
            else
            {
