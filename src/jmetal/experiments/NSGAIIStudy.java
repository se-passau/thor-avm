...
/**
 * Class implementing an example of experiment using NSGAII as base algorithm.
...
*/
     ParsedFM featureModel = new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-290.xml");

      for (int i = 0; i < numberOfAlgorithms; i++){
            parameters[i].put("runTime_", 1000); // 1 sec
            parameters[i].put("populationSize_", 100);
            parameters[i].put("archiveSize_", 100);
            parameters[i].put("mutationProbability_", 0.01);
            parameters[i].put("featureModel", featureModel);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    exp.problemList_     = new String[] {"FM290r"};
    ...
    exp.paretoFrontFile_ = new String[] {"FM290_5obj.pf"} ;
