...
/**
 * Class implementing an example of experiment using MOCell as base algorithm.
...
//      parameters[3].put("mutationProbability_", 0.2);
//      parameters[4].put("mutationProbability_", 0.3); 
//      parameters[5].put("mutationProbability_", 0.4);
//      parameters[6].put("mutationProbability_", 0.5);
//      parameters[7].put("mutationProbability_", 0.6);
//      parameters[8].put("mutationProbability_", 0.7); 
//      parameters[9].put("mutationProbability_", 0.8); 
//      parameters[10].put("mutationProbability_", 0.9); 
      /*
