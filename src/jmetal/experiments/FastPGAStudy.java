 ...
 * in FastPGA.
 */
public class FastPGAStudy extends Experiment {
  /**
...
*/
      ...
      for (int i = 0; i < numberOfAlgorithms; i++)
        algorithm[i] = new FastPGA_Settings(problemName).configure(parameters[i]);
      
    } catch (IllegalArgumentException ex) {
      Logger.getLogger(FastPGAStudy.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public static void main(String[] args) throws JMException, IOException {
    FastPGAStudy exp = new FastPGAStudy() ; // exp = experiment
    
    exp.experimentName_  = "FastPGAStudy" ;
    exp.algorithmNameList_   = new String[] {"FastPGA"};
