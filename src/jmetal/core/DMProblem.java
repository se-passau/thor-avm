 ...
 */
public class DMProblem extends Problem {
	
	private DimacsFM dfm;
    
 /** 
  * Creates a default FM43 problem (43 variables and 5 objectives)
  * @param solutionType The solution type must "Binary". 
  */
  public DMProblem(String solutionType) throws ClassNotFoundException {
  ...
  * @param solutionType The solution type must "Binary". 
  */
  public DMProblem(String solutionType, 
               Integer numberOfBits, 
  		         Integer numberOfObjectives, DimacsFM dfm) throws ClassNotFoundException {
