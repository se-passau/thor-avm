...
public class FM72Br extends Problem {   

  private static ParsedFM featureModel;
    
  public FM72Br(String solutionType) throws ClassNotFoundException {
    this(solutionType, 72, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-72B.xml"));
  }

  public FM72Br(String solutionType, 
   ...
   // } //for
    ...
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities72B.csv");
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
        ...
        // one rule in this FM
        if (!variable.bits_.get(50) && !variable.bits_.get(51)) other_viol++;
