...
public class FM168r extends Problem {   

  private static ParsedFM featureModel;
    
  public FM168r(String solutionType) throws ClassNotFoundException {
    this(solutionType, 168, 5, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-168.xml"));
  }

  public FM168r(String solutionType, 
   ...
   // } //for
    ...
    //public static final ParsedFM featureModel = new ParsedFM("src\\jmetal\\problems\\FMr\\FM-168.xml");
    public static final int FEATURES = 168;
	...
	public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities168.csv");
