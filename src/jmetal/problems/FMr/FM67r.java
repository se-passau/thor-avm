...
public class FM67r extends Problem {   

  private static ParsedFM featureModel;
    
  public FM67r(String solutionType) throws ClassNotFoundException {
    this(solutionType, 67, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-67.xml"));
  }

  public FM67r(String solutionType, 
   ...
   // } //for
    ...
    //public static final ParsedFM featureModel = new ParsedFM("src\\jmetal\\problems\\FMr\\FM-67.xml");
    public static final int FEATURES = 67;
    public static final int [] [] requires_pairs = {{22,48} , {32,49} , {12,37} , {24,46}};
    
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities67.csv");
