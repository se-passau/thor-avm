...
public class FM43Br extends Problem {   

  private static ParsedFM featureModel;
    
  public FM43Br(String solutionType) throws ClassNotFoundException {
    this(solutionType, 43, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-43B.xml"));
  }

  public FM43Br(String solutionType, 
   ...
   // } //for
    ...
    //public static final ParsedFM featureModel = new ParsedFM("src\\jmetal\\problems\\FMr\\FM-43.xml");
    public static final int FEATURES = 43;
    public static final int [] [] requires_pairs = {{36,5} , {36,2} , {10,11}};
    ...
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities43B.csv");
