...
public class FM70r extends Problem {   

  private static ParsedFM featureModel;
    
  public FM70r(String solutionType) throws ClassNotFoundException {
    this(solutionType, 70, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-70.xml"));
  }

  public FM70r(String solutionType, 
   ...
   // } //for
    ...
    //public static final ParsedFM featureModel = new ParsedFM("src\\jmetal\\problems\\FMr\\FM-70.xml");
    public static final int FEATURES = 70;
    public static final int [] [] requires_pairs = {{56,52}};
    
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities70.csv");
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
        ...
        if (variable.bits_.get(56) && variable.bits_.get(57)
                 && variable.bits_.get(58) && variable.bits_.get(59)
                 && variable.bits_.get(61)) other_viol++;
