...
public class FM66r extends Problem {   

  private static ParsedFM featureModel;
    
  public FM66r(String solutionType) throws ClassNotFoundException {
    this(solutionType, 66, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-66.xml"));
  }

  public FM66r(String solutionType, 
   ...
   // } //for
    ...
    //public static final ParsedFM featureModel = new ParsedFM("src\\jmetal\\problems\\FMr\\FM-66.xml");
    public static final int FEATURES = 66;
    public static final int [] [] requires_pairs = {{33,31} , {33,32}};
     
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities66.csv");
