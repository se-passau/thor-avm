...
public class FM44r extends Problem {   

  private static ParsedFM featureModel;
    
  public FM44r(String solutionType) throws ClassNotFoundException {
    this(solutionType, 44, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-44.xml"));
  }

  public FM44r(String solutionType, 
   ...
   // } //for
    ...
    //public static final ParsedFM featureModel = new ParsedFM("src\\jmetal\\problems\\FMr\\FM-44.xml");
    public static final int FEATURES = 44;
    public static final int [] [] requires_pairs = { {31,11} , {38,11} , {33,10} , {35,3} , {36,3}
                                                    ,{37,6}};
    
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities44.csv");
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
        ...
        // Two rule in this FM: c7 and c8
        if (variable.bits_.get(17) && variable.bits_.get(21)) excludes_viol++;
        if (variable.bits_.get(17) && variable.bits_.get(30)) excludes_viol++;
