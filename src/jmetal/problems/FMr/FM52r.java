...
public class FM52r extends Problem {   

  private static ParsedFM featureModel;
    
  public FM52r(String solutionType) throws ClassNotFoundException {
    this(solutionType, 52, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-52.xml"));
  }

  public FM52r(String solutionType, 
   ...
   // } //for
    ...
    //public static final ParsedFM featureModel = new ParsedFM("src\\jmetal\\problems\\FMr\\FM-52.xml");
    public static final int FEATURES = 52;
    public static final int [] [] requires_pairs = {{15,25} , {16,25} , {17,25}};
    
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities52.csv");
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
        ...
        if (!(!variable.bits_.get(38) || variable.bits_.get(39)
                 || variable.bits_.get(42)  || variable.bits_.get(45)
                 || variable.bits_.get(48))) other_viol++;
