...
public class Ptoybox3 extends Problem {
    ...
    public Ptoybox3(String solutionType) throws ClassNotFoundException {
	this(solutionType, FEATURES, 5,
	     new DimacsFM(Ptoybox3.class.getResource("/dimacs/toybox.dimacs").getPath(),
			  FEATURES));
    }
  
    public Ptoybox3(String solutionType, 
	...
	if (numberOfObjectives_ == 5){
	    ...
	    // Fourth: Minimize the total cost
	    solution.setObjective(3, computeCosts(variable, COST2, INTERACT2)); 

	    // Fifth: Minimize the total cost
	    solution.setObjective(4, computeCosts(variable, COST3, INTERACT3));
	} else {
