...
public class Pbuildroot extends Problem {   

  public static final int FEATURES = 14910;	
  //public static final DimacsFM dfm = new DimacsFM("dimacs\\buildroot.dimacs", FEATURES);	
  
  public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\dimacs\\14910B.csv");
  ...
  public Pbuildroot(String solutionType) throws ClassNotFoundException {
	  this(solutionType, FEATURES, 5,new DimacsFM("..\\trunk2\\dimacs\\buildroot.dimacs", FEATURES));
  }
  
  public Pbuildroot(String solutionType, 
