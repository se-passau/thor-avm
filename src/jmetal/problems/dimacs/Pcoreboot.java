...
public class Pcoreboot extends Problem {   

  public static final int FEATURES = 12268;	
  //public static final DimacsFM dfm = new DimacsFM("dimacs\\coreboot.dimacs", FEATURES);	
  
  public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\dimacs\\coreboot.csv");
  ...
  public Pcoreboot(String solutionType) throws ClassNotFoundException {
	  this(solutionType, FEATURES, 5,new DimacsFM("..\\trunk2\\dimacs\\coreboot.dimacs", FEATURES));
  }
  
  public Pcoreboot(String solutionType, 
