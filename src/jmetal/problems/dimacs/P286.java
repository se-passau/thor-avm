...
public class P286 extends Problem {   
 ...
 //public static final DimacsFM dfm = new DimacsFM("dimacs\\2.6.28.6-icse11.dimacs", FEATURES);	
  ...
  public void evaluate(Solution solution) throws JMException {
      ...
      if (numberOfObjectives_ == 12){
          ...
          solution.setObjective(4, num_violations);
          solution.setObjective(5, num_violations);
          solution.setObjective(6, num_violations);
          solution.setObjective(7, num_violations);

          // Second: Maximize the total number of features
          // Here: we minimize the missing features
          solution.setObjective(8, FEATURES - num_features); 

          // Third: Maximize the number of features that were used before
          // Here: we minimize the features that WERE'NT used before
          solution.setObjective(9, num_features - num_used_before); 

          // Fourth: Minimize the number of known defects in the chosen features
          solution.setObjective(10, num_defects); 

          // Fifth: Minimize the total cost
          solution.setObjective(11, actual_cost); 
      }
      ...
      if (numberOfObjectives_ == 2){
          //solution.setObjective(0, num_violations); 
          solution.setObjective(0, FEATURES - num_features); 
          //solution.setObjective(1, actual_cost); 
          //solution.setObjective(1, num_defects); 
          solution.setObjective(1, num_features - num_used_before); 
