...
public class IBEA_mainDM {
  ...
  public static void main(String [] args) throws JMException, IOException, ClassNotFoundException {
    ...
    DimacsFM dfm = new DimacsFM("..\\trunk2\\dimacs\\uClinux.dimacs", 1850);
    ...
    algorithm.setInputParameter("runTime",1005000);
    algorithm.setInputParameter("breakpoints", breakpoints);
    algorithm.setInputParameter("paretoFile", "PF//FM1850_8obj.pf");

    // Mutation and Crossover for Binary codification 
    parameters = new HashMap() ;
    parameters.put("probability", 0.00) ;
    parameters.put("distributionIndex", 20.0) ;
    crossover = CrossoverFactory.getCrossoverOperator("FMCrossover", parameters);                    
    
    parameters = new HashMap() ;
    parameters.put("probability", 1.0/1850) ;
    parameters.put("distributionIndex", 20.0) ;
    parameters.put("dimacs", dfm);
