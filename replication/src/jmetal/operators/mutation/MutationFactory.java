...
public class MutationFactory {
  ...
  public static Mutation getMutationOperator(String name, HashMap parameters) throws JMException{
    ...
    else if (name.equalsIgnoreCase("FMMutator"))
        return new FMMutator(parameters);
    else if (name.equalsIgnoreCase("DMBitFlipMutation"))
    	return new DMBitFlipMutation(parameters);
    else
    {
