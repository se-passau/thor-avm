 ...
 */
public class DMBitFlipMutation extends Mutation {
  /**
  ...
  private DimacsFM dfm;
	 ...
	 */
	public DMBitFlipMutation(HashMap<String, Object> parameters) {
		super(parameters) ;
  	if (parameters.get("probability") != null)
  		mutationProbability_ = (Double) parameters.get("probability") ;
  	if (parameters.get("dimacs") != null)
		dfm = (DimacsFM) parameters.get("dimacs");
	} // BitFlipMutation
