...
public class PuClinuxconfig extends Problem {   

  public static final int FEATURES = 11254;	
  //public static final DimacsFM dfm = new DimacsFM("dimacs\\uClinux-config.dimacs", FEATURES);	
  
  public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\dimacs\\uClinux-config.csv");
  ...
  public PuClinuxconfig(String solutionType) throws ClassNotFoundException {
	  this(solutionType, FEATURES, 5,new DimacsFM("..\\trunk2\\dimacs\\uClinux-config.dimacs", FEATURES));
  }
  
  public PuClinuxconfig(String solutionType, 
