...
public class Pembtoolkit extends Problem {   

  public static final int FEATURES = 23516;	
  //public static final DimacsFM dfm = new DimacsFM("dimacs\\embtoolkit.dimacs", FEATURES);	
  
  public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\dimacs\\embtoolkit.csv");
  ...
  public Pembtoolkit(String solutionType) throws ClassNotFoundException {
	  this(solutionType, FEATURES, 5, new DimacsFM("..\\trunk2\\dimacs\\embtoolkit.dimacs", FEATURES));
  }
  
  public Pembtoolkit(String solutionType, 
