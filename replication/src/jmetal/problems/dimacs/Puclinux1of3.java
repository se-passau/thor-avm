...
public class Puclinux1of3 extends Problem {

    public static final int FEATURES = 1850;	
    public static DimacsFM dimacs;
    
    public static ObjectiveParser op =
	new ObjectiveParser(Puclinux1of3.class.getResource("/dimacs/uclinux.csv").getPath());
	...
	URL interactFile =  Puclinux1of3.class.getResource(path);
    ...
    public Puclinux1of3(String solutionType) throws ClassNotFoundException {
	this(solutionType, FEATURES, 5,
	     new DimacsFM(Puclinux1of3.class.getResource("/dimacs/uclinux.dimacs").getPath(),
			  FEATURES));
    }
  
    public Puclinux1of3(String solutionType, 
