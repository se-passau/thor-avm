...
public class Pfreetz extends Problem {   

  public static final int FEATURES = 31012;	
  //public static final DimacsFM dfm = new DimacsFM("dimacs\\freetz.dimacs", FEATURES);	
  
  public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\dimacs\\freetz.csv");
  ...
  public Pfreetz(String solutionType) throws ClassNotFoundException {
	  this(solutionType, FEATURES, 5,new DimacsFM("..\\trunk2\\dimacs\\freetz.dimacs", FEATURES));
  }
  
  public Pfreetz(String solutionType, 
