...
public class Plinux1of3 extends Problem {

    public static final int FEATURES = 6888;	
    public static DimacsFM dimacs;
    
    public static ObjectiveParser op =
	new ObjectiveParser(Plinux1of3.class.getResource("/dimacs/linux.csv").getPath());
	...
	URL interactFile =  Plinux1of3.class.getResource(path);
    ...
    public Plinux1of3(String solutionType) throws ClassNotFoundException {
	this(solutionType, FEATURES, 5,
	     new DimacsFM(Plinux1of3.class.getResource("/dimacs/linux.dimacs").getPath(),
			  FEATURES));
    }
  
    public Plinux1of3(String solutionType, 
