...
public class Pecos1of3 extends Problem {

    public static final int FEATURES = 1244;	
    public static DimacsFM dimacs;
    
    public static ObjectiveParser op =
	new ObjectiveParser(Pecos1of3.class.getResource("/dimacs/ecos.csv").getPath());
	...
	URL interactFile =  Pecos1of3.class.getResource(path);
    ...
    public Pecos1of3(String solutionType) throws ClassNotFoundException {
	this(solutionType, FEATURES, 5,
	     new DimacsFM(Pecos1of3.class.getResource("/dimacs/ecos.dimacs").getPath(),
			  FEATURES));
    }
  
    public Pecos1of3(String solutionType, 
