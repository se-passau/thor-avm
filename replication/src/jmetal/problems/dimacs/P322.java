...
public class P322 extends Problem {   

  public static final int FEATURES = 60072;	
  //public static DimacsFM dfm = ;	
  
  public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\dimacs\\60072B.csv");
  ...
  public P322(String solutionType) throws ClassNotFoundException {
	  this(solutionType, 60072, 5, new DimacsFM("..\\trunk2\\dimacs\\2.6.32-2var.dimacs", FEATURES));
  }
  
  public P322(String solutionType, 
