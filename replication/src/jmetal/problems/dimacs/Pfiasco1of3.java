...
public class Pfiasco1of3 extends Problem {

    public static final int FEATURES = 1638;	
    public static DimacsFM dimacs;
    
    public static ObjectiveParser op =
	new ObjectiveParser(Ptoybox1of3.class.getResource("/dimacs/fiasco.csv").getPath());
	...
	URL interactFile =  Pfiasco1of3.class.getResource(path);
    ...
    public Pfiasco1of3(String solutionType) throws ClassNotFoundException {
	this(solutionType, FEATURES, 5,
	     new DimacsFM(Pfiasco1of3.class.getResource("/dimacs/fiasco.dimacs").getPath(),
			  FEATURES));
    }
  
    public Pfiasco1of3(String solutionType, 
