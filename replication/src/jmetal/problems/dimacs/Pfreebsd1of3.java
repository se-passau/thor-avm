...
public class Pfreebsd1of3 extends Problem {

    public static final int FEATURES = 1396;	
    public static DimacsFM dimacs;
    
    public static ObjectiveParser op =
	new ObjectiveParser(Pfreebsd1of3.class.getResource("/dimacs/freebsd.csv").getPath());
	...
	URL interactFile =  Pfreebsd1of3.class.getResource(path);
    ...
    public Pfreebsd1of3(String solutionType) throws ClassNotFoundException {
	this(solutionType, FEATURES, 5,
	     new DimacsFM(Pfreebsd1of3.class.getResource("/dimacs/freebsd.dimacs").getPath(),
			  FEATURES));
    }
  
    public Pfreebsd1of3(String solutionType, 
