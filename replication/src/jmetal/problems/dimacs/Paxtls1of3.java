...
public class Paxtls1of3 extends Problem {

    public static final int FEATURES = 684;	
    public static DimacsFM dimacs;
    
    public static ObjectiveParser op =
	new ObjectiveParser(Paxtls1of3.class.getResource("/dimacs/axtls.csv").getPath());
	...
	URL interactFile =  Paxtls1of3.class.getResource(path);
    ...
    public Paxtls1of3(String solutionType) throws ClassNotFoundException {
	this(solutionType, FEATURES, 5,
	     new DimacsFM(Paxtls1of3.class.getResource("/dimacs/axtls.dimacs").getPath(),
			  FEATURES));
    }
  
    public Paxtls1of3(String solutionType, 
