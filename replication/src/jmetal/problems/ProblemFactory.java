...
public class ProblemFactory {
  ...
  public Problem getProblem(String name, Object [] params) throws JMException {
    ...
    String base = "jmetal.problems.FMr.";
    if(name.charAt(0)=='P') //dumb hack
    	base = "jmetal.problems.dimacs.";
...
//      base += "cec2009Competition.";    
    ...
    try {
//      System.out.println(Class.forName("jmetal.problems.FMr.FM137r"));
//      System.out.println(Class.forName(base+name).getConstructors());
//      System.out.println(base+name);
//      System.out.println(Class.forName("jmetal.problems.dimacs.P322"));
//      System.out.println(Class.forName(base+name).getConstructors());
