...
public class FM60r extends Problem {   

  private static ParsedFM featureModel;
    
  public FM60r(String solutionType) throws ClassNotFoundException {
    this(solutionType, 60, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-60.xml"));
  }

  public FM60r(String solutionType, 
   ...
   // } //for
    ...
    //public static final ParsedFM featureModel = new ParsedFM("src\\jmetal\\problems\\FMr\\FM-60.xml");
    public static final int FEATURES = 60;
    public static final int [] [] requires_pairs = {{2,1}};
    
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities60.csv");
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
        ...
        if (variable.bits_.get(29) && variable.bits_.get(30)) excludes_viol++;
