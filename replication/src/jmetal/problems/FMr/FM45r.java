...
public class FM45r extends Problem {   

  private static ParsedFM featureModel;
    
  public FM45r(String solutionType) throws ClassNotFoundException {
    this(solutionType, 45, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-45.xml"));
  }

  public FM45r(String solutionType, 
   ...
   // } //for
    ...
    //public static final ParsedFM featureModel = new ParsedFM("src\\jmetal\\problems\\FMr\\FM-45.xml");
    public static final int FEATURES = 45;
    public static final int [] [] requires_pairs = {{11,7} , {32,44} , {34,44} , {33,39}};
    
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities45.csv");
