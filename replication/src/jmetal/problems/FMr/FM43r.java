...
public class FM43r extends Problem {   

  private static ParsedFM featureModel;
    
  public FM43r(String solutionType) throws ClassNotFoundException {
    this(solutionType, 43, 8, new ParsedFM("..\\trunk2\\jmetal\\problems\\FMr\\FM-43.xml"));
  }

  public FM43r(String solutionType, 
   ...
   // } //for
    ...
    public static ObjectiveParser op = new ObjectiveParser("..\\trunk2\\jmetal\\problems\\FMr\\qualities43.csv");
