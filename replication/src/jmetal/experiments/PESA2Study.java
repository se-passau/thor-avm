 ...
 * in FastPGA.
 */
public class PESA2Study extends Experiment {
  /**
...
*/
      ...
      for (int i = 0; i < numberOfAlgorithms; i++)
        algorithm[i] = new PESA2_Settings(problemName).configure(parameters[i]);
      
    } catch (IllegalArgumentException ex) {
      Logger.getLogger(PESA2Study.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public static void main(String[] args) throws JMException, IOException {
    PESA2Study exp = new PESA2Study() ; // exp = experiment
    
    exp.experimentName_  = "PESA2Study" ;
    exp.algorithmNameList_   = new String[] {"PESA2"};
