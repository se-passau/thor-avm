...
public class IBEA_Settings extends Settings {
  ...
  public double mutationDistributionIndex_  ;
    ...
    Object [] problemParams = {"Binary"}; //, new DimacsFM(problemName_)
    problem_ = (new ProblemFactory()).getProblem(problemName_, problemParams);      
		...
		System.out.println("Runtime: " + runTime_);
		System.out.println(populationSize_);
		algorithm.setInputParameter("runTime", runTime_);
		algorithm.setInputParameter("features", features_);
