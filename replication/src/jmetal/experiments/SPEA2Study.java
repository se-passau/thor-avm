...
/**
 * Class implementing an example of experiment using SPEA2 as base algorithm.
 * The experiment consisting in studying the effect of the crossover probability
 * in SPEA2.
 */
public class SPEA2Study extends Experiment {
  /**
...
*/
      ...
      for (int i = 0; i < numberOfAlgorithms; i++)
        algorithm[i] = new SPEA2_Settings(problemName).configure(parameters[i]);
      
    } catch (IllegalArgumentException ex) {
      Logger.getLogger(SPEA2Study.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public static void main(String[] args) throws JMException, IOException {
    SPEA2Study exp = new SPEA2Study() ; // exp = experiment
    
    exp.experimentName_  = "SPEA2Study" ;
